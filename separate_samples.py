# python separate_samples.py --dataset cifar10 --model resnet18 --trigger_type signalTrigger --batch_size 1 --clean_ratio 0.20 --poison_ratio 0.80 --gamma_low 0.0 --gamma_high 19.71682357788086 --checkpoint_load ./saved/backdoored_model/poison_rate_0.8/withTrans/cifar10/resnet18/signalTrigger/9.tar
import sys
import os
...
def save_samples_pickle(file_path, data):
...
def separate_samples(arg, trainloader, model, gamma_low, gamma_high):
    ...
    save_samples_pickle(data_path_clean, clean_samples)
    save_samples_pickle(data_path_poison, poison_samples)
    save_samples_pickle(data_path_suspicious, suspicious_samples)
