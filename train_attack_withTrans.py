#python train_attack_withTrans.py --dataset cifar10 --model resnet18 --trigger_type signalTrigger --epochs 200
...
def main():
    ...
    # Write
    save_folder_path = os.path.join('./saved/backdoored_model', 'poison_rate_'+str(arg.poison_rate), 'withTrans', arg.dataset, arg.model, 'trial'+str(arg.trigger_type))
